...
export const UPDATE_ACCOUNT_STATUS_LOADING = "UPDATE_ACCOUNT_STATUS_LOADING";
...
export const UPDATE_ACCOUNT_STATUS_CLEAN = "UPDATE_ACCOUNT_STATUS_CLEAN";
...
export const PRODUCT_EDIT_UPDATE_SUCCESS = "PRODUCT_EDIT_UPDATE_SUCCESS";
export const PRODUCT_EDIT_DELETE_FAIL = "PRODUCT_EDIT_DELETE_FAIL";
export const PRODUCT_EDIT_UPDATE_FAIL = "PRODUCT_EDIT_UPDATE_FAIL";
